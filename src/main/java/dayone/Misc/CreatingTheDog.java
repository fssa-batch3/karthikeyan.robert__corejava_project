...
public class CreatingTheDog {
	// Attributes
		private boolean hasDots;
		private String color;

		// Constructor
		public CreatingTheDog(boolean hasDots, String color) {
		...
		public static void main(String[] args) {
			...
			CreatingTheDog dog1 = new CreatingTheDog(true, "purple");
			CreatingTheDog dog2 = new CreatingTheDog(true, "blue");
